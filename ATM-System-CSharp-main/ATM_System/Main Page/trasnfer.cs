                        ...
                        if (bal == bal3)
                        {
                            if (bal2 > bal4)
                            {
                                ...
                                if (result == DialogResult.OK)
                                {
                                    ...
                                    QR.Image.Save(@"E:\BUBT_Education_File\6th Semester\CSE-200_(Software Development-II)\New folder\ATM-System-CSharp-main\Transaction\" + TransactionID + ".jpg");
                                    con.Open();
